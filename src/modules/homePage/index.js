      ...
      <div className={styles.content}>
        <div className={styles.filter}>
          ...
          <div className={styles.category}>
            ...
            />
            <Checkbox
              label={<span style={{ fontSize: 14 }}>Bộ lọc dầu</span>}
            />
            <Checkbox
          ...
          <div className={styles.category}>
            ...
            <Checkbox
              label={<span style={{ fontSize: 14 }}>Asakashi(24)</span>}
            />
          ...
          <div className={styles.category}>
            ...
            <Checkbox
              label={<span style={{ fontSize: 14 }}>Nhật Bản(24)</span>}
            />
            <Checkbox
              label={<span style={{ fontSize: 14 }}>Trung Quốc</span>}
            />
          </div>
        </div>
